...
| ✅ 2.52 | **Tor analogowy CVBS w Panoramie (2026-09-05 15:30).** Źródło pobierane `cvbs` = `rtsp://127.0.0.1:8554/uav` — czysty H.264 640×480/30 z usługi `pi5-uas-rtsp` (PI5setup, nie ruszamy), tej samej, z której korzysta NAGRYWARKA i ATAK. MediaMTX ciągnie na żądanie (`started on demand` gdy ktoś patrzy), więc bez widza analog nie kosztuje nic. Dodane przez API admina, widoczne; mozaika ma teraz 4 kafelki (2×2). Strona główna odświeża listę źródeł sama co 20 s — wcześniej nowe źródło pojawiało się dopiero po przeładowaniu | dok/REJESTRATORY.md, serwer/README.md |
